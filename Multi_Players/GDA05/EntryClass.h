...
private:
	...
	Ogre::SceneManager*		mPrimary;
	Ogre::SceneManager*		mSecondary;
	Ogre::Camera*			mPrimaryCam;
	Ogre::Camera*			mSecondaryCam;

	bool					_isServer;

public:
	EntryClass(bool server)
		: _isServer(server)
	{
	...
	virtual void createScene()
	{
		...
		_mc = new MainClass(mWindow, mPrimary, mSecondary, _isServer);
