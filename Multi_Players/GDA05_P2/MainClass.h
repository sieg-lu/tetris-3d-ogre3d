...
public:
	...
	MainClass(RenderWindow* inWin, SceneManager* inManager1, SceneManager* inManager2)
...
// 		_currentStatus2P->Initialize();
		...
		_customKeys1P = new CustomKeys(ExampleFrameListener::mKeyboard, _currentStatus1P, "GDA03Keys1P.xml", _peerClient);
//		_customKeys2P = new CustomKeys(ExampleFrameListener::mKeyboard, _currentStatus2P, "GDA03Keys2P.xml", _peerClient);
